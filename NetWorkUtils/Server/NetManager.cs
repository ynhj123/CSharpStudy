...
namespace NetWorkUtils.Server
{
    class NetManager
    {
        ...
        static Dictionary<String, MethodInfo> msgHandlers = new Dictionary<string, MethodInfo>();

        public static void StartLoop(int listenPort)
        {
            MethodInfo[] methodInfos = typeof(MsgHandler).GetMethods();
            foreach (var item in methodInfos)
            {
                msgHandlers[item.Name] = item;
            }
        ...
        public static void ReadListenfd(Socket listenfd)
        {
            try
            {
                ...
                Debug.WriteLine("Accept " + clientfd.RemoteEndPoint.ToString());
